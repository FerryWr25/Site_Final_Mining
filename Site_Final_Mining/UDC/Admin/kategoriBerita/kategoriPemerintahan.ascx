<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="kategoriPemerintahan.ascx.cs" Inherits="Site_Final_Mining.UDC.Admin.kategoriBerita.kategoriPemerintahan" %>
