<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="kategoriKejahatan.ascx.cs" Inherits="Site_Final_Mining.UDC.Member.kategoriBerita.kategoriKejahatan" %>


<section class="content-header">
    <h1>Konten Berita Kejahatan
        <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Member</a></li>
        <li class="active">kategori kejahatan</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="box-title" style="margin-top: 5px">Tabel Berita Kejahatan</h1>
