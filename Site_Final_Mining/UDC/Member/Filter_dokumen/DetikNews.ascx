<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DetikNews.ascx.cs" Inherits="Site_Final_Mining.UDC.Member.Filter_dokumen.DetikNews" %>

<section class="content-header">
    <h1>Konten Berita Detik.Com
