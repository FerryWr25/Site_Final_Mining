<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TribunNews.ascx.cs" Inherits="Site_Final_Mining.UDC.Member.Filter_dokumen.TribunNews" %>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="box-title" style="margin-top: 5px">Dokumen Berita Tribunnews.com</h1>
                                            ...
                                            <Columns>
                                                <asp:TemplateField ItemStyle-Width="1000" ItemStyle-HorizontalAlign="Justify">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="SumberBerita" runat="server">
                                                            <span class="label label-success">
                                                                <i class="fa fa-book" aria-hidden="true"></i>&nbsp;<%# Eval("site_name") %></span>
                                                        </asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        ...
                                                        <br />
                                                        <asp:Label ID="konten" runat="server"><%# Eval("news").ToString().Substring(0, Eval("news").ToString().Length-(Eval("news").ToString().Length)/2)+"[.....]" %></asp:Label><br />
                                                        <br />
