<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReadMore_TribunNews.ascx.cs" Inherits="Site_Final_Mining.UDC.Member.Filter_dokumen.ReadMore_TribunNews" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="input-group input-group-sm date">
                                <asp:LinkButton OnClick="backTribun_Click" runat="server" CssClass="btn btn-primary">
