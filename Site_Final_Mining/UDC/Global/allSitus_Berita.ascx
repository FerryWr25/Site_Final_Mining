<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="allSitus_Berita.ascx.cs" Inherits="Site_Final_Mining.UDC.Global.allSitus_Berita" %>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="box-title" style="margin-top: 5px">Tabel Berita</h1>
