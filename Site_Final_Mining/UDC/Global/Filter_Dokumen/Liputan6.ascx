<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Liputan6.ascx.cs" Inherits="Site_Final_Mining.UDC.Global.Filter_Dokumen.Liputan6" %>

<section class="content-header">
    <h1>Konten Berita Liputan6.Com
