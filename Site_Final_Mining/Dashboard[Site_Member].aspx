<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard[Site_Member].aspx.cs" Inherits="Site_Final_Mining.Dashboard_Site_Member_" %>
...
<head runat="server">
    ...
    <title>MiningSite_Timeframe | Member</title>
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="../../index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>Member</b>Here</span>
                </a>
                        ...
                        <small class="pull-right">20%</small>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">Hidayatir Rizkiyah</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="admin-lte/img/ce.jpg" class="img-circle" alt="User Image">
                                        <p>
                                            Hidayatir Rizkiyah - System Analyst
                  <small>Member since Nov. 2012</small>
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <asp:Button ID="btnKeluar_dashMember" Text="Sign out" CssClass="btn btn-default btn-flat" runat="server" OnClick="keluarClick" />
                                        </div>
                                    </li>
                                </ul>
                            </li>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview" id="menu_kategori_berita" runat="server">
                            ...
                            <ul class="treeview-menu">
                                <li id="kategori_berita_olahraga" runat="server" class="">
                                    <asp:LinkButton ID="olahraga" runat="server">
                                    <i class="fa fa-caret-right"></i>Olahraga
                                    </asp:LinkButton>
                                </li>
                                <li id="kategori_berita_politik" runat="server" class="">
                                    <asp:LinkButton ID="politik" runat="server">
                                    <i class="fa fa-caret-right"></i>Politik
                                    </asp:LinkButton>
                                </li>
                                <li id="kategori_berita_kejahatan" runat="server" class="">
                                    <asp:LinkButton ID="kejahatan" runat="server">
                                    <i class="fa fa-caret-right"></i>Kejahatan
                                    </asp:LinkButton>
                                </li>
                                <li id="kategori_berita_kecelakaan" runat="server" class="">
                                    <asp:LinkButton ID="kecelakaan" runat="server">
                                    <i class="fa fa-caret-right"></i>Kecelakaan
                                    </asp:LinkButton>
                                </li>
                                <li id="kategori_berita_bencana_alam" runat="server" class="">
                                    <asp:LinkButton ID="bencana_alam" runat="server">
                                <i class="fa fa-caret-right"></i>Bencana Alam
                                    </asp:LinkButton>
                                </li>
                                <li id="kategori_berita_lain_lainnya" runat="server" class="">
                                    <asp:LinkButton ID="lain_lainnya" runat="server">
                                    <i class="fa fa-caret-right"></i>Lain-lain..
                                    </asp:LinkButton>
                                </li>
                            </ul>
                        </li>
                        <li id="menu_all_konten_beria" runat="server">
                            <a href="#">
                                <i class="fa fa-th"></i><span>Semua Konten Berita</span>
                                <span class="pull-right-container">
                        ...
                        <li class="treeview" id="statistic_berita" runat="server">
                            <a href="#">
                                <i class="fa fa-bar-chart"></i><span>Statistic Kategori Berita</span>
                                <span class="pull-right-container">
                        ...
                        <li>
                            ...
                            <li class="treeview" id="Li1" runat="server">
                                <a href="#">
                                    <i class="fa fa-bar-chart"></i><span>Konten Berita</span>
                                    <span class="pull-right-container">
            ...
            <div class="content-wrapper">
                <asp:PlaceHolder ID="Dasboard_Member" runat="server" EnableViewState="false"></asp:PlaceHolder>
            </div>
            <!-- /.content-wrapper -->
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2018-2019 <a href="#">Hidayatir Rizkiyah</a>.</strong> All rights
    reserved.
            </footer>
